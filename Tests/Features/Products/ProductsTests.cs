...
public class CreateProductTests : TestBase
{
    ...
    public async Task ShouldCreateProductWithValidData()
    {
        ...
        var response = await Client.PostAsJsonAsync($"{ApiVersion.Path}/products/create", payload);
...
public class GetProductsTests : TestBase
{
    ...
    public async Task ShouldReturnProductsForUser()
    {
        ...
        var response = await Client.GetAsync($"{ApiVersion.Path}/products/all");
...
public class UpdateProductTests : TestBase
{
    ...
    public async Task ShouldUpdateProductWhenOwned()
    {
        ...
        var createResponse = await Client.PostAsJsonAsync($"{ApiVersion.Path}/products/create", new { Name = "Old Name" });
        ...
        var updateResponse = await Client.PutAsJsonAsync($"{ApiVersion.Path}/products/update", updatePayload);
    ...
    public async Task ShouldReturn404WhenProductNotFound()
    {
        ...
        var response = await Client.PutAsJsonAsync($"{ApiVersion.Path}/products/update", payload);
    ...
    public async Task ShouldReturn404WhenProductBelongsToAnotherUser()
    {
        ...
        var createResponse = await Client.PostAsJsonAsync($"{ApiVersion.Path}/products/create", new { Name = "Owner Product" });
        var product = await createResponse.Content.ReadFromJsonAsync<Product>();
...
public class DeleteProductTests : TestBase
{
    ...
    public async Task ShouldDeleteProductWhenOwned()
    {
        ...
        var createResponse = await Client.PostAsJsonAsync($"{ApiVersion.Path}/products/create", new { Name = "Delete Me" });
        var product = await createResponse.Content.ReadFromJsonAsync<Product>();

        var deletePayload = new { ProductId = product!.Id };
        var deleteResponse = await Client.DeleteAsJsonAsync($"{ApiVersion.Path}/products", deletePayload);

        deleteResponse.StatusCode.Should().Be(HttpStatusCode.NoContent);

        var allResponse = await Client.GetAsync($"{ApiVersion.Path}/products/all");
    ...
    public async Task ShouldReturn404WhenProductNotFound()
    {
        ...
        var response = await Client.DeleteAsJsonAsync($"{ApiVersion.Path}/products", payload);
        response.StatusCode.Should().Be(HttpStatusCode.NotFound);
    }

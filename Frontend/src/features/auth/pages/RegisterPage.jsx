      ...
      <div className="card shadow-sm" style={{ maxWidth: '400px', width: '100%' }}>
        <div className="card-body p-4">
          ...
          <div className="text-center mt-2">
            <span className="text-body-secondary small">By creating an account, you agree to our <a href={`${import.meta.env.VITE_SOURCE_URL}/blob/main/TERMS.md`} target="_blank" rel="noopener noreferrer" className="text-decoration-none">Terms of Use</a>.</span>
          </div>
        </div>
      </div>
    </Background>
